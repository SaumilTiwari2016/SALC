...
const ProductsTab = () => {
  ...
  return (
    <Fragment>
      ...
      <div>
        {!products.length ||
          products.map(({ id, name, description, price, imagePath, articleNo }) => (
            <div
              key={id}
            ...
            >
              ...
              <div className="mr-3 flex-1">{articleNo}</div>
              ...
              onClick={() => selectedData({ id, name, description, price, imagePath, articleNo })}
               >
